...
from StreamASRLib.model import WavQwenBaseModel
...
class WavQwenModelRawEmb(WavQwenBaseModel):
    ...
    def __init__(self, model, fast_tokenizer=True):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(
            WavQwenModelRawEmb.QWEN_REPO, use_fast=fast_tokenizer)
    ...
    def init(cls):
        qwen_model = AutoModelForCausalLM.from_pretrained(
            WavQwenModelRawEmb.QWEN_REPO)
        base_emb = qwen_model.model.embed_tokens
        ext_emb = ExtendedEmbedding(
            base_emb, WavQwenModelRawEmb.EXT_TOKENS, WavQwenModelRawEmb.AUDIO_TOKEN_THRESHOLD)
